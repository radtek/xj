 ...
 * generated in the com.gafis.xj.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Check_QNAME = new QName("http://webservice.xj.gafis.com", "check");
    private final static QName _CheckResponse_QNAME = new QName("http://webservice.xj.gafis.com", "checkResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.gafis.xj.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.xj.gafis.com", name = "check")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.xj.gafis.com", name = "checkResponse")
